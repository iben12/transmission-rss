...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__delay__ = __webpack_require__(141);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__delay___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__delay__);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('menu-item', {
    props: ['item'],
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('episode-group', {
    props: ['group'],
    template: `
        <div class="group">
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('episode', {
    props: ['episode'],
    template: `
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('feed', {
    props: ['feed'],
    template: '<li><a :href="feed.url" target="_blank">{{ feed.url }}</a></li>'
});

var body = new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    el: ".content",
    data: {
        episodes: [],
        groupedEpisodes: [],
    ...
    methods: {
        getEpisodes: function() {
            ...
            this.notify = true;
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('api/episodes').then( (response) => {
                __WEBPACK_IMPORTED_MODULE_3__delay___default()(1000).wait.then( () => {
        ...
        download: function() {
            ...
            let vue = this;
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get(url).then(response => {
        ...
        cleanup: function() {
            ...
            this.notify = true;
            __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get('api/cleanup').then( response => {
        ...
        groupEpisodes: function() {
            let reducedEpisodes = this.episodes.reduce( (reduced, episode) => {
                let date = __WEBPACK_IMPORTED_MODULE_1_moment___default()(episode.created_at).format('YYYY/MM/DD');
                /*if (!reduced[date]) {
                    reduced[date] = [];
                }
        ...
        notifyTimeout: function() {
            ...
            this.d = __WEBPACK_IMPORTED_MODULE_3__delay___default()(2000);
            this.d.wait.then( () => {
                this.notify = false;
            }).catch( () => {
                console.log('dropped');
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(3), __webpack_require__(139)))
